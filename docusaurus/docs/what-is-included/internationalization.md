...
The integration of `react-intl` into Next.js is made by [next-intl](https://github.com/moxystudio/).
...
Please check `next-intl` [documentation](https://github.com/moxystudio/next-intl#custom-policies) to know more.
